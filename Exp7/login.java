...
public class login extends HttpServlet {   
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<header style = 'text-align: right'>" + email + "&nbsp; &nbsp; &nbsp; &nbsp;");
        ...
        try
        {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/cart", "root", "");
            if(conn==null)
            {
            ...
            out.println("<form action='Total.jsp' method='post'>");
